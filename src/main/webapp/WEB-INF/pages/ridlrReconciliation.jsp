...
<script type="text/javascript">
	...
	function agentSummaryDetail() {
		...
		if (flag) {
			$.ajax({
				type : 'POST',
				url : '${pageContext.request.contextPath}/ajax/paymentReconciliationDetailsAjaxCall',
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<form:form id="ridlrPayDetail" cssClass="form-horizontal"
					...
					<div class="form-group">
						<div class="control-label col-xs-3">
							<form:label path="dataFor">Data of</form:label>
						</div>
						<div class="col-xs-6">
							<form:select cssClass="form-control" path="dataFor" id="dataFor" onfocus="dataForErrorHide();">
								<form:option value="NONE" label="--- Select ---" />
								<form:option value="AllData" label="All Data" />
								<form:option value="TrimaxData" label="Trimax Data" />
								<form:option value="RidlrData" label="Ridlr Data" />
							</form:select>
						</div>
					</div>
...
<!--                         <th>GUID</th> -->
                        ...
                        <th>Full Ticket</th>
                        <th>Half Ticket</th>
                        <th>ETIM Total Amont</th>
                        <th>From Name</th>
                        <th>Till Name</th>
                         <th>Transaction Date</th>
<!--                         <th>Transaction Time</th> -->
                        <th>Vendor Reference No.</th>
